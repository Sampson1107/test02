...
<p>The GoogLeNet model has been tested with this new version on a GPU cluster, which includes 4 nodes, and each of which has 4 M40 GPUs. A 13X speedup has been achieved on 16 GPUs compared with 1 GPU. The batch size used in the tests is 128, and the datasets is ImageNet. </p>
...
<ul>
<li><p>Shaohua Wu; Shutao Song;</p></li>
</ul>
</article>
  </div>
